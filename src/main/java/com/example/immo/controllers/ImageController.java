...
public class ImageController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Image served.", content = {
                    @Content(mediaType = "image/png"), @Content(mediaType = "image/jpeg") }),
        ...
        try {
            ...
            if (resource.exists() || resource.isReadable()) {
                ...
                if (!Objects.equals(mimeType, "image/jpeg") && !Objects.equals(mimeType, "image/png"))
                    return new ResponseEntity<DefaultResponseDto>(new DefaultResponseDto("Not a valid Image."),
                ...
                return new ResponseEntity<DefaultResponseDto>(new DefaultResponseDto("This image can't be found."),
